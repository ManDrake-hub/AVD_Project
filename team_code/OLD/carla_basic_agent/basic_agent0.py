...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, opt_dict={}, map_inst=None, grp_inst=None, index=None):
        """
        ...
        """
        # TODO: This is our agent that receives our settings and the associated vehicle
        # if we change where the parameters are loaded, we are good to go
        # TODO: add vehicle inst to get which parameters file to load
