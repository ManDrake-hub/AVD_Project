...
class BehaviorAgent(BasicAgent):
    ...
    def predict_ego_data(self, prev_offset, step):
        if step < 0:
            return self._predict_ego_data_prev(step)
    ...
    def run_step(self, debug=False):
        ...
        # Aree di interesse
        sensors = [("right", 0, 5, 10, 170), ("left", 0, 5, -170, -10), ("front", 0, 5, -5, 5), ("ahead", 0, 25, -90, 90), ("ahead_short", 0, 10, -90, 90)]
        offsets = []
        ...
        while step < max_steps:
            ...
            if step != -1:
                ego_transform_pred, ego_loc_pred = self.predict_ego_data(_prev_offset, step if not step < 0 else step * 2)
