...
class ResultOutputProvider(object):
    ...
    def create_output_text(self):
        ...
        # TODO: This creates the results, it checks the names and verifies if already present
        # so if we change the name based on car, we can get different lines for each of them
