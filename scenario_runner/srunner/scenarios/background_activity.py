...
class BackgroundBehavior(AtomicBehavior):
    ...
    # TODO: handles traffic generation

    def __init__(self, ego_actors, route, debug=False, name="BackgroundBehavior"):
        """
        Setup class members
        """
        ...
        # Global variables
        # TODO: cambiamo il leading vehicle che genera macchine
        self.camera_index = 0
        self._ego_actors = ego_actors
        self._ego_actor = ego_actors[self.camera_index]
    ...
    def on_press(self, key):
        try:
            if key == keyboard.Key.space:
                self._ego_actor = self._ego_actors[self.camera_index]
                return
    ...
    def _initialise_road_behavior(self, road_wps):
        ...
        for wp in road_wps:
            ...
            # Spawn actors
            # TODO: modifica questo ed elimina il fatto che ne generi molti di più di quanto necessario
